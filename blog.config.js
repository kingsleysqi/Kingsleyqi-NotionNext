...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || "30eb6394e3f581d192a6e869e7d56347", // ← 你的数据库 ID，已填入

  THEME: process.env.NEXT_PUBLIC_THEME || "hexo", // ← 改成 heo 主题 其他主题有heo,
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 60, // ← 改回官方数据60
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || "light", // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [18, 6], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || "Kingsley Qi", // ← 你的名字
  BIO:
    process.env.NEXT_PUBLIC_BIO ||
    "Exploring the boundaries of design & technology from Batangas.", // ← 你的简介
  LINK: process.env.NEXT_PUBLIC_LINK || "https://www.kingsleyqi.cn", // ← 你的网站地址
  KEYWORDS:
    process.env.NEXT_PUBLIC_KEYWORD ||
    "Kingsley Qi, Design, Technology, Batangas", // ← 关键词
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || "/favicon.svg", // ← 你的 favicon（用你上传的 SVG）
